...
<body oncontextmenu="return false">
	<div class="container">
		<?php
		    ...
		    $sql_kate = "SELECT * FROM forum_kateg";
		    $wynik_kate = $conn->query($sql_kate);
		  ?>
		<form method="post" id="Edycja" action="/dodawanie_tabeli_posty.php" onreset='if (!confirm("Czy na pewno chcesz zresetować cały formularz?")) return false'>
		                   <table>
